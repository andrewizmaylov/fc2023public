                ...
                <div class="flex">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <NavLink :href="route(element.path)"
                                 :active="$page.url.includes(element.base_uri)"
...
const navigation = [
    ...
    {
        id: 5,
        name: t('pages.partners'),
        path: 'club.partners_presentation',
        base_uri: 'partners',
        external: false,
    },
];

let menu_image = computed(() => page.props?.auth?.user?.profile_photo_url ?? '/img/ball_small.png');
