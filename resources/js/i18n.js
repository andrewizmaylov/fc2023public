...
export const messages = {
	en: {
		...
		partners: {
			position_header: 'Advertising Opportunities',
			selected: 'You choose',
			order_summary: 'Order summary',
			subtotal: 'Subtotal',
			shipping_estimate: 'Shipping estimate',
			learn_more_shipping: 'Learn more about how shipping is calculated',
			learn_more_tax: 'Learn more about how tax is calculated',
			tax_estimate: 'Tax estimate',
			order_total: 'Order total',
			checkout: 'Send request',
			select_before_place_order: 'Order can\'t not be empty',
		},
		merch: {
			order_date: 'Order date: ',
			size: 'Size',
			sizes: 'See sizing chart',
			choose_size: 'Choose a size',
			colors: 'Colors',
			choose_color: 'Choose a color',
			all_reviews: 'See all reviews',
			add_chart: 'Add to cart',
			reviews: 'Reviews',
			images: 'Images',
		},
		team: {
			...
			appointment_message: 'Предоставьте текст который необходимо отобразить в качестве приветствия и краткого руководства к действию. <br /> Данный текст должен отображать регламент и правила отбора игрока в клуб',
		},
		tabs: {
			all_teams: 'All teams',
			...
			book_appointment: 'Become a member',
			faq: 'FAQ',
			partners_presentation: 'Partners presentation',
			catalog: 'Catalog',
			contacts: 'Contacts',
		},
		pages: {
	...
	ru: {
		...
		partners: {
			position_header: 'Рекламные возможности',
			selected: 'Вы выбрали',
			order_summary: 'Итого',
			subtotal: 'Промежуточный итог',
			shipping_estimate: 'Стоимость доставки',
			learn_more_shipping: 'Подробнее о расчете стоимости доставки',
			learn_more_tax: 'Подробнее о налогах',
			tax_estimate: 'Налоги',
			order_total: 'Полная стоимость',
			checkout: 'Отправить заявку',
			select_before_place_order: 'Заявка не может быть пустая',
		},
		merch: {
			order_date: 'Дата заказа: ',
			size: 'Размер',
			sizes: 'Все размеры',
			choose_size: 'Выбери размер',
			colors: 'Доступные цвета',
			choose_color: 'Выбери цвет',
			all_reviews: 'Смотреть все отзывы',
			add_chart: 'В корзину',
			reviews: 'Отзывы',
			images: 'Изображения',
		},
		team: {
			...
			players: 'Игроки',
			book_appointment: 'Запись на просмотр',
			appointment_message: 'Предоставьте текст который необходимо отобразить в качестве приветствия и краткого руководства к действию. <br /> Данный текст должен отображать регламент и правила отбора игрока в клуб',
		},
		tabs: {
			...
			news: 'Новости',
			games: 'Игры',
			partners: 'Для спонсоров',
			book_appointment: 'Отбор в команду',
			stadiums: 'Наши стадионы',
			stadiums_other: 'Гостевые площадки',
			fans_info: 'Информация для болельщиков',
			faq: 'Вопросы Ответы',
			partners_presentation: 'Презентация для партнеров',
			catalog: 'Каталог',
			contacts: 'Контакты',
		},
		pages: {
			appointment: 'Заявки на просмотр',
			order: 'Заказы',
