...
export default {
    ...
    plugins: [forms, typography, aspectratio,
        ...
        function ({ addUtilities }) {
            addUtilities({
                '.text_68': {
                    '@apply lg:text-[68px] md:text-[57px] sm:text-[46px] text-[34px]': {},
                },
                '.text_56': {
                    '@apply lg:text-[56px] md:text-[44px] sm:text-[42px] text-[20px]': {},
                },
                '.text_34': {
                ...
                '.border_ld': {
                    '@apply border border-[#383247]/20 dark:border-[#fafafa]/20': {},
                },
                '.border_ld_dashed': {
                ...
                '.bg_contrast': {
                    '@apply bg-gray-50 dark:bg-gray-700 text_ld opacity-90 hover:opacity-100 duration-75': {},
                },
                '.btn_main': {
                ...
                '.btn_ld_border': {
                    '@apply inline-flex items-center px-4 py-2 font-semibold text-xs uppercase tracking-widest transition rounded hover:bg-[#0f172a] dark:hover:bg-[#444857] dark:text-[#fafafa] text-[#383247] hover:text-white duration-75 border border-[#444857]': {},
                },
                '.ringed_10': {
                ...
                '.opacity_90': {
                    '@apply opacity-100 hover:opacity-90 duration-300 cursor-pointer scale-100 hover:scale-105': {},
                },
                '.upload_btn': {
                ...
                '.header_68': {
                    '@apply text_68 text_ld font-bold font-play opacity-80': {},
                },
                '.header_56': {
                    '@apply text_56 text_ld font-bold font-play opacity-80': {},
                },
                '.header_34': {
                ...
                '.menu_ld': {
                    '@apply bg-white dark:bg-gray-800 border-gray-100 dark:border-gray-700': {},
                },
                // ...
            });
        }
